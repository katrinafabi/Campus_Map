...
List<Offset> classroomIconPositions = [//1
...
List<Offset> bathroomIconPositions = [//2
  Offset(634, 170), //5wc
...
List<Offset> facultyIconPositions = [//3
  Offset(560, 250), //18deanCED
  Offset(624, 614), //27facultyroom
  Offset(287, 499), //49deanCAFA
  Offset(240, 509), //50facultyroom
];
List<Offset> laboratoryIconPositions = [//4
  
];
List<Offset> computerlaboratoryIconPositions = [//5
  Offset(732, 157), //2MISlab
  Offset(769, 157), //3comlab
  Offset(802, 153), //4comlab
];
List<Offset> officeIconPositions = [//6
  Offset(469, 510), //35work
  Offset(441, 518), //36dostwork
];
List<Offset> wheelchairIconPositions = [//7
  Offset(700, 148), //6
];
List<Offset> libraryIconPositions = [//8
  Offset(506, 137),//1library
];

List<IconData> classroomIconList = [//1
  Icons.class_, //7
  Icons.class_, //8
...
List<IconData> bathroomIconList = [//2
  Icons.wc, //5
  Icons.wc, //37wcm
  Icons.wc, //38wcf
  Icons.wc, //62
...
List<IconData> officeIconList = [//6  
  Icons.work, //35
  Icons.work, //36dost
];
List<IconData> wheelchairIconList = [//7
  Icons.wheelchair_pickup, //6
];
List<IconData> libraryIconList = [//8
